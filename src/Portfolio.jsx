    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <section id="inicio" className="scroll-mt-24 mx-auto max-w-5xl px-4 pt-14 pb-10">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <a href="https://mail.google.com/mail/?view=cm&to=joseriverosuarez95@gmail.com&su=Consulta%20desde%20el%20portafolio&body=Hola%20José%2C%20" target="_blank" rel="noreferrer" className="rounded-2xl px-4 py-2 border shadow-sm hover:shadow"> ✉️ Envíame un correo (Gmail)</a>
        </div>
