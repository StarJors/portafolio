export default function Portfolio() {
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      {/* HERO */}
      <section id="inicio" className="mx-auto max-w-5xl px-4 pt-14 pb-10">
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight">
          Desarrollador Web <span className="text-zinc-500">(Python/Django)</span>
        </h1>
        <p className="mt-4 text-zinc-600 max-w-2xl">
          Backend con Django, reportes y despliegue en Render/Vercel. Aquí muestro proyectos reales y stack diario.
        </p>
        <div className="mt-6 flex flex-wrap gap-3">
          <a href="#proyectos" className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 border shadow-sm hover:shadow">
            Ver proyectos ➜
          </a>
          <a href="CV_Jose_Rivero.pdf" download className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 border shadow-sm hover:shadow">
            ⬇️ Descargar CV
          </a>
          <a href="mailto:rivero@example.com" className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 border shadow-sm hover:shadow">
            ✉️ Contactar
          </a>
        </div>
        <div className="mt-6 flex gap-4">
          <a className="underline" href="https://github.com/StarJors">GitHub</a>
          <a className="underline" href="#">LinkedIn</a>
        </div>
      </section>

      {/* PROYECTOS */}
      <section id="proyectos" className="mx-auto max-w-5xl px-4 py-12">
        <h2 className="text-3xl font-bold tracking-tight">Proyectos</h2>
        <p className="mt-2 text-zinc-600">Selección de trabajo reciente.</p>
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          {/* Card */}
          <article className="rounded-2xl border p-5 shadow-sm hover:shadow-md bg-white">
            ...
            <div className="mt-4 flex gap-3 text-sm">
              ...
              <a className="underline" href="#">Código</a>
            </div>
          </article>
      ...
      {/* HABILIDADES */}
      <section id="habilidades" className="mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          {[
            ...
            <div key={cat} className="rounded-2xl border p-5 bg-white">
      ...
      {/* EXPERIENCIA */}
      <section id="experiencia" className="mx-auto max-w-5xl px-4 py-12">
        <h2 className="text-3xl font-bold tracking-tight">Experiencia</h2>
        <ul className="mt-6 space-y-4">
          <li className="rounded-2xl border p-5 bg-white">
      ...
      <section id="contacto" className="mx-auto max-w-5xl px-4 py-12">
        <div className="rounded-2xl border p-8 bg-white">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <a href="https://github.com/StarJors" className="rounded-2xl px-4 py-2 border shadow-sm hover:shadow">GitHub</a>
            <a href="#" className="rounded-2xl px-4 py-2 border shadow-sm hover:shadow">LinkedIn</a>
          </div>
        </div>
      </section>
